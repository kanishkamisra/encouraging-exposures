...
#         for lr in ${lrs[@]}
#         do
#             python src/simulation.py --model_name kanishka/smolm-autoreg-bpe-seed_$seed --gaussian --lr $lr --experiment_name single_stimuli_dative_simulation_valtest_vbd_arunachalam_template_rt_$template
#         done
#     done
# done
