...
do
    ...
    do
        ...
        python src/simulation.py --model_name kanishka/smolm-autoreg-bpe-seed_$seed --gaussian --lr $lr --experiment_name single_stimuli_dative_simulation_valtest_vbd_no_markedness_discourse_recipient_given_template_1
