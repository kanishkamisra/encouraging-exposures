...
This script has been slightly modified by Kanishka Misra and Najoung Kim.
"""
...
train_file="/scratch/corpora/babylm_data/babylm_100M/aochildes.train"
dev_file="/scratch/corpora/babylm_data/babylm_dev/aochildes.dev"
...
def main():
    ...
    print(tokenizer.convert_ids_to_tokens(train_dataset['input_ids'][0]))
