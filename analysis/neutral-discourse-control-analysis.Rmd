...
```
DO: it was a good day . mommy [verbed] me a ball.
PP: it was a good day . mommy [verbed] a ball to me .
```
...
mode = "_valtest_vbd_neutral_discourse"
...
# use explicit interaction formulae
# think about item_id --> it doesn't even vary across feature configs. maybe hypothesis_id is better -- and maybe this will converge with random slopes (due to GP)
...
y ~ b_0 + b_1(x1) + b_2(x2) + b_3(x1 * x2) 

theme_animacy was significant (\beta )

<!--- 0-1 = treatment coding -->
